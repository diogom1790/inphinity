...
for file_name in list_files:
    ...
    if len(taxo) == 7 or 'staphylococcus_aureus' in file_name.lower():
        ...
        if 'staphylococcus_aureus' in file_name.lower():
            family_obj = Family(designation = 'Staphylococcaceae')
            genus_obj = Genus(designation = 'Staphylococcus')
            specie_obj = Specie(designation = 'Staphylococcus Aureus')
