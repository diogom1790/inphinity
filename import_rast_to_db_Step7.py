...
for file_name in list_files:
    ...
    print(file_name)
    if len(taxo) == 7 or 'klebsiella_pneumoniae' in file_name.lower():
        ...
        if 'klebsiella_pneumoniae' in file_name.lower():
            family_obj = Family(designation = 'Enterobacteriaceae')
            genus_obj = Genus(designation = 'Klebsiella')
            specie_obj = Specie(designation = 'Klebsiella pneumoniae')
