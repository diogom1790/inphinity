...
class DeleteRest(object):
    """
    This class manage the delete requests
    ...
    def performRequest(self):
        ...
        result_request = requests.delete(url_post, headers=self.headers, data=self.data)
        if result_request.status_code == 204 or result_request.status_code == 201 :
