...
def createGene(id_bacterium, dna_sequence, id_db_online, function = None, fasta_head = None, start_contig = None, end_contig = None, fk_contig = None):
    """
...
list_proteins = fasta_protein_aa_obj_dict.get_list_of_proteins()
...
for protein in list_proteins:
    CDS_sequence = fasta_protein_CDS_obj_dict.get_nucleotid_sequence_by_key(protein.id_accession)
    aa_sequence = fasta_protein_aa_obj_dict.get_protein_sequence_by_key(protein.id_accession)
    id_gene = createGene(id_bacterium = id_bacterium, dna_sequence = CDS_sequence, id_db_online = protein.id_accession)
    createProtein(id_db_online = protein.id_accession, fk_organism= id_bacterium, fk_gene = id_gene, sequence_aa = aa_sequence, description = protein.designation)
