...
for file_name in list_files:
    ...
    print(file_name)
    if len(taxo) == 7 or 'streptococcus_tigurinus' in file_name.lower():
        ...
        if 'streptococcus_tigurinus' in file_name.lower():
            family_obj = Family(designation = 'Streptococcaceae')
            genus_obj = Genus(designation = 'Streptococcus')
            specie_obj = Specie(designation = 'Streptococcus Tigurinus')
